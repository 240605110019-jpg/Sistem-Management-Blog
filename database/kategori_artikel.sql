...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Apr 2026 pada 15.18
...
(2, 'Tutorial', 'artikel panduan demi langkah'),
(3, 'Database', 'Artikel seputaran pengolahan Database'),
(4, 'Web Desaign', 'Artikel tentang desain antarmuka web');
